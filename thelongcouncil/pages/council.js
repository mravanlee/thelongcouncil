...
const COUNCIL_MEMBERS = [
  ...
  { type: 'framer', monogram: 'ER', name: 'Eleanor Roosevelt', role: 'Human rights architect · Universal Declaration of Human Rights', lifespan: '1884 — 1962', country: 'United States', positions: ['Human rights are meaningless without political membership — the stateless have no rights to claim', 'Economic and social rights are as fundamental as civil and political rights — not separate, not secondary', 'Moral authority without coercive power has real limits — institutions must be built to close the gap'] },
  ...
  { type: 'framer', monogram: 'RL', name: 'Rosa Luxemburg', role: 'Revolutionary theorist · The Accumulation of Capital', lifespan: '1871 — 1919', country: 'Poland / Germany', positions: ['Capitalism requires continuous geographical expansion — imperialism is its economic form, not a policy choice', 'Freedom is always, and exclusively, freedom for the one who thinks differently', 'Socialism or barbarism — the historical choice is not between two forms of progress'] },
  ...
  { type: 'framer', monogram: 'WM', name: 'Wangari Maathai', role: 'Political ecologist · The Green Belt Movement', lifespan: '1940 — 2011', country: 'Kenya', positions: ['Environmental degradation is a governance failure, not a technical problem', 'Democratic accountability is the precondition for ecological recovery — communities protect what they govern', "Women's empowerment is structural — not cultural — because women are the primary stewards of resources at risk"] },
];
