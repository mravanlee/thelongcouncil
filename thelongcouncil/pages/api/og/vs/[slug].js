    ...
    return new ImageResponse(
      (
        <div style={{ width: '1080px', height: '1350px', background: '#f3eeea', display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Faces — flex space-between zet VS exact in het midden */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '40px 40px 0', height: '480px' }}>
            <img src={portrait1} style={{ width: '420px', objectFit: 'contain' }} />

            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ width: '2px', height: '80px', background: '#6b1a1a', marginBottom: '14px', transform: 'rotate(20deg)' }} />
              <div style={{ display: 'flex', fontFamily: 'Playfair Display', fontWeight: 500, fontSize: '80px', color: '#6b1a1a', lineHeight: 1 }}>VS</div>
            </div>

            <img src={portrait2} style={{ width: '420px', objectFit: 'contain' }} />
          </div>

          {/* Names — zelfde flex structuur als faces */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '0 40px', marginTop: '20px' }}>
            <div style={{ width: '420px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ display: 'flex', fontFamily: 'Playfair Display', fontWeight: 500, fontSize: '28px', color: '#6b1a1a', letterSpacing: '2px', textAlign: 'center' }}>{member1.name.toUpperCase()}</div>
              <div style={{ width: '50px', height: '2px', background: '#6b1a1a', marginTop: '10px' }} />
            </div>
            <div style={{ width: '160px' }} />
            <div style={{ width: '420px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ display: 'flex', fontFamily: 'Playfair Display', fontWeight: 500, fontSize: '28px', color: '#6b1a1a', letterSpacing: '2px', textAlign: 'center' }}>{member2.name.toUpperCase()}</div>
              <div style={{ width: '50px', height: '2px', background: '#6b1a1a', marginTop: '10px' }} />
            </div>
          </div>

          {/* Quote anchor block — lichter dan de rest */}
          <div style={{ flex: 1, background: '#ede5df', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 120px', position: 'relative', marginTop: '40px' }}>
            <div style={{ position: 'absolute', left: '80px', top: '30px', display: 'flex', fontSize: '70px', color: '#6b1a1a', fontFamily: 'Playfair Display', lineHeight: 1 }}>“</div>
            ...
            <div style={{ position: 'absolute', right: '80px', bottom: '30px', display: 'flex', fontSize: '70px', color: '#6b1a1a', fontFamily: 'Playfair Display', lineHeight: 1 }}>”</div>
          </div>
          ...
          <div style={{ height: '180px', background: 'linear-gradient(180deg, #6b1a1a, #3b0e0e)', color: '#f3eeea', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <div style={{ display: 'flex', fontFamily: 'Inter', fontSize: '16px', letterSpacing: '2px', opacity: 0.85, marginBottom: '12px' }}>
